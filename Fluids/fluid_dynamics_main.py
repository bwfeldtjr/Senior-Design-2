...
import math
import os
#FIX ALL IMPORTS TO HOW IT WILL WORK IN GETHUB
from reynolds import Reynoldsnum
from major_head_loss import HlMajor
from minor_head_loss import HlMinor
os.chdir("C:\\0Files\\0KSU\\0Class\\0Semester8\\Senior Design\\Temperary\\Chemistry")
from Chemistry import primary_density, primary_viscosity
...
def fluidDynamics(fluidTempReactor, fluidTempHeatEx):
    ...
    densityR = primary_density(fluidTempReactor)*1000#kg/m^3
    densityHE = primary_density(fluidTempHeatEx)*1000#kg/m^3
    viscosityR = primary_viscosity(fluidTempReactor)/1000#Pa*s
    viscosityHE = primary_viscosity(fluidTempHeatEx)/1000#Pa*s
