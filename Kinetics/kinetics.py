...
vol = 100# 8*2.5**2*math.pi*28316.8
volF = 100 #Volume of Fuel (cm^3)
volM = 1000 #Volume of Moderator (cm^3)
...
for i in range(len(Temp1)):
    ...
    if i ==0:
        T1 = 900 #K (Actual Temp)
        n_pop = 10**5 #Neutron Population (to be determined)
        con = 0 #Concentration of Precursor (to be determined)
    else:
        T1 = Temp1[i-1]
