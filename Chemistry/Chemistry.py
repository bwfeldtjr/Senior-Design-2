...
def primary_density(T):
    " This function returns density of the fuel mixture in g/cm^3, T must be in celsius "
    density = 2.38 - (40E-5) * T
    return density

def primary_viscosity(T):
    " This function returns viscosity of the fuel mixture in cP, T must be in celsius "
    viscosity = 8.4 
    return viscosity

def secondary_density(T): 
    " This function returns density of the coolant mixture in g/cm^3, T must be in celsius "
